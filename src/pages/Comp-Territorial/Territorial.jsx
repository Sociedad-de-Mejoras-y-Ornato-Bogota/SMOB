...
const Territorial = () => {
    ...
    return (
        <>
                    <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/circulos/Componente+Territorial/Final+componente+territorial.png" name_component="Componente territorial"
