            ...
            <div className="general-container">
                <div className="row responsive-columna">
                    ...
                    <div className="col-lg-6">
                        <img src="https://geoapps.esri.co/recursos/SMOB/circulos/Componente Poblacional/CÍRCULO CONTEXTO SOCIOCULTURAL-01.png" style={{width:"400px", height:"400px"}}className="imagen-responsive" ></img>
                    </div>
