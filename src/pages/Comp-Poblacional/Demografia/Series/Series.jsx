    ...
    <div className='general-container' ref={seriesRef}>
      ...
      <div className='row' style={{width:"100vw",height:"97vh"}}>
        ...
        <iframe
          ...
          className='dashboards' referrerPolicy='origin'
       ...
       <div className='row responsive-columna' style={{height:"25vh",width:"100vw",color:"black"}}>
         <div className='col-lg-2'></div>
         <div className='col-lg-8' style={{display:"flex",flexDirection:"column",justifyContent:"center",color:"#762f0b", fontSize:"18px"}}>
        <p>
          Serie de población de Colombia con base en estimaciones DANE, SMOB y Álvaro Pachon M.
        </p>
         </div>
         <div className='col-lg-2'></div>
