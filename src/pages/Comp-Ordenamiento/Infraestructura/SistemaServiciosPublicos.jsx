        ...
        <div className="general-container">
            <div className="row responsive-columna">
                ...
                <div className="col-lg-6">
                    <img src="https://smob-storage.s3.us-east-2.amazonaws.com/circulos/ordenamiento/3.1.2.%20Sistemas%20de%20servicios%20p%C3%BAblicos%20ind-01.png" width={"80%"} height={"90%"} 
                ...
                <div className="col-lg-6">
                    ...
                    <div className="general-content text-responsive" style={{textAlign:"justify"}}>
                        Una línea de tiempo en la que se observen los hitos del desarrollo de
                        ...
                        alcantarillado, y sistemas de comunicaciones.
                    </div>
                </div>
            </div>
        </div>
