...
export default function CiudaniaYCivilidad() {
  ...
  return (
    <>
      <Page_libro url_ver_mas="https://smob-storage.s3.us-east-2.amazonaws.com/libros/construyendo-civilidad/SMOB_Ciudadania y civilidad_web.pdf" url_book="https://smob-storage.s3.us-east-2.amazonaws.com/libros/construyendo-civilidad/SMOB_Ciudadania%20y%20civilidad_web.pdf" name_component="Ciudadanía y civilidad" />
