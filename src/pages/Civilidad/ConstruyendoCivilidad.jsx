...
function ConstruyendoCivilidad() {
    return (
        <>
            <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/General/GR%C3%81FICA+TRI%C3%81NGULOS+-+CONSTRUYENDO+CIVILIDAD+.png" name_component="Construyendo civilidad" 
            ...
            audio='https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/recursos_15_02_2024/Audio Reseña Construyendo civilidad.mp3'/>
        </>
    )
}
