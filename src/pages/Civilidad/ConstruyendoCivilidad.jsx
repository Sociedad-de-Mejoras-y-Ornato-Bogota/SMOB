...
function ConstruyendoCivilidad() {
    return (
        <>
            <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/General/Modelo+general+140526.png" name_component="Construyendo civilidad" 
