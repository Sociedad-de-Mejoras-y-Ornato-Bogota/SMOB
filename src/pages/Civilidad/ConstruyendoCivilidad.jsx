...
function ConstruyendoCivilidad() {
    return (
        <>
            <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/General/GR%C3%81FICA+TRI%C3%81NGULOS+V7+DATACIVILIDAD-01.png" name_component="Construyendo civilidad" 
