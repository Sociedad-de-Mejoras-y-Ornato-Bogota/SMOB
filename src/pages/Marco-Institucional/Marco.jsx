...
export default function Marco() {
    ...
    return (
        <>
            <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/MarcoInstitucional/0.+imagen+general+140526.png" name_component="Sistemas regularorios" description_component="El eje conceptual a lo largo del cual se desarrollan los sistemas regulatorios, es
