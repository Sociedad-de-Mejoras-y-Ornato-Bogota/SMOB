...
export default function Marco() {
    ...
    return (
        <>
            <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/MarcoInstitucional/0.+Imagen+general110526.png" name_component="Marcos regularorios" description_component="El eje conceptual a lo largo del cual se desarrollan los marcos regulatorios, es
