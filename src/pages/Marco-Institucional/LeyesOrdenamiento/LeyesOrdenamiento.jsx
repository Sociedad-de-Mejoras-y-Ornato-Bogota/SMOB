...
areas={
    ...
    <div className="contenedorLO">
        <div className="botonesLO">
          <Link to={`/sistemas regulatorios/Leyes de ordenamiento territorial/Antecedentes de la Ley 388 de 1997`} className="botonLO">Antecedentes de la Ley 388 de 1997</Link>
          <Link to={`/sistemas regulatorios/Leyes de ordenamiento territorial/Esquema de la Ley 388 de 1997`} className="botonLO">Esquema de la Ley 388 de 1997</Link>
        </div>
      </div>
        </>
    )
