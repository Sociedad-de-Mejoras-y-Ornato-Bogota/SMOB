...
const Instrumentos = () =>{
    ...
    return (
        <>
            <Page_principal
                name_component="Instrumentos" description_component=""
                url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/Bienestar/3.3.+Instrumentos+-+general.png"
                areas={
                    [
