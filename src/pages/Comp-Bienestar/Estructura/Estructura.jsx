...
const EstructuraUrb = () =>{    
    ...
    return(
        <>
            <Page_principal
                name_component="Estructura urbana" description_component=""
                url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/Bienestar/3.2. Estructura urbana - general.png"
                areas={
                    [
