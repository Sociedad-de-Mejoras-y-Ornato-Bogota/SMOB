...
const SistemaEP = () => {
    ...
    return (
        <>
        <Page_principal url_imagen="https://smob-storage.s3.us-east-2.amazonaws.com/recursosSMOB/Bienestar/3.1.3. Sistemas de espacio público.png" name_component="Sistema de espacio público" description_component=" Los espacios públicos que la ciudad pone al servicio de
