                ...
                description={[
                    ...
                    "Cada uno de los 3 elementos está estructurado en torno a cuatro componentes esenciales: el general, el poblacional, el territorial y el de bienestar, que interactúan dinámicamente en la construcción del modelo de ciudad del presente y del futuro. " ]} urls_content={
                        [
                            ...
                            { url: "https://smob-storage.s3.us-east-2.amazonaws.com/modelos+de+ciudad/2.+POT_Pol%2CObj%2CEst%2CPla+2.pdf", title: "Politicas, objetivos, estrategias y planes" },
                            { url: "https://smob-storage.s3.us-east-2.amazonaws.com/modelos+de+ciudad/3.%2BPOT%2BNormativa+2.pdf", title: "Normas" },
                            { url: "https://smob-storage.s3.us-east-2.amazonaws.com/modelos+de+ciudad/4.+Cartograf%C3%ADa+POT+2021.pdf", title: "Cartografía" }]} />
        </>
    )
}
